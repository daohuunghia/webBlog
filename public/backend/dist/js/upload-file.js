...
function resetInput(id) {
    $('input#' + id).val('/backend/images/default.jpg');
    $('#image-preview-' + id).attr('src', '/backend/images/default.jpg');
}
