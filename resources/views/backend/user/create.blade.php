                            ...
                            <div class="card-body">
                                <form class="form-horizontal" action="" method="POST">
                                    ...
                                    <div class="form-group row">
                                        ...
                                        <div class="col-sm-10">
                                            <input type="email" name="email" value="{{ old('email') }}" class="form-control" placeholder="{{ trans('backend.Email') }}">
                                            @if ($errors->has('email'))
                                    ...
                                    <div class="form-group row">
                                        ...
                                        <div class="col-sm-10">
                                            <input type="password" name="re_password" class="form-control" placeholder="{{ trans('backend.Re password') }}">
                                        ...
                                        <div class="col-sm-10">
                                            ...
                                            <div style="display: inline-block;border: 2px solid #ded8d8;border-radius: 100%;padding: 4px;">
                                                <img id="image-preview-avatar" class="img-fluid"
                                                     onclick="open_popup('/filemanager/dialog.php?type=1&popup=1&field_id=avatar&akey={{ $keyAccessFileManagerBackend}}')"
                                                     src="{{ old('avatar') ?? '/backend/images/default.jpg' }}" style="max-width: 250px;width: 100px;height: 100px;border-radius:100%;">
                                            </div><br>
                                    ...
                                    <div class="form-group row">
                                        ...
                                        <div class="col-sm-10">
                                            <input type="number" name="phone" value="{{ old('phone') }}" class="form-control" placeholder="{{ trans('backend.Số điện thoại') }}">
                                            @if ($errors->has('phone'))
                                    ...
                                    <div class="form-group row">
                                        ...
                                        <div class="col-sm-10">
                                            <input type="text" name="job" value="{{ old('job') }}" class="form-control" placeholder="{{ trans('backend.Nghề nghiệp') }}">
                                        </div>
                                    </div>
                                    <div class="form-group row">
