                            ...
                            <div class="card card-primary">
                                ...
                                <div class="card-body row">
                                    <div class="form-group col-md-12 {{ $errors->first('vi_title') ? 'has-error' : '' }}">
                                        ...
                                        <input type="text" name="vi_title" class="form-control" id="vi_title" />
                                    ...
                                    <div class="form-group col-md-12">
                                        <label for="avatar">{{ trans('backend.Avatar') }}</label>
                                    ...
                                    <div class="form-group col-md-12">
                                        <img src="{{asset('backend/images/default.jpg')}}" style="max-width: 250px"/>
                                    </div>
                                    <div class="form-group col-md-12">
                                        <div class="row">
                                            <div class="col-md-3">
                            ...
                            <div class="card card-primary">
                                ...
                                <div class="card-body row">
                                    <div class="form-group col-md-12 {{ $errors->first('vi_keyword') ? 'has-error' : '' }}">
                                        ...
                                        <textarea name="vi_keyword" id="vi_keyword" class="form-control" rows="4"></textarea>
                                    ...
                                    <div class="form-group col-md-12 {{ $errors->first('en_keyword') ? 'has-error' : '' }}">
                                        ...
                                        <textarea name="en_keyword" id="en_keyword" class="form-control" rows="4"></textarea>
                                    ...
                                    <div class="form-group col-md-12 {{ $errors->first('vi_description') ? 'has-error' : '' }}">
                                        ...
                                        <textarea name="vi_description" id="vi_description" class="form-control" rows="4"></textarea>
                                    ...
                                    <div class="form-group col-md-12 {{ $errors->first('en_description') ? 'has-error' : '' }}">
                                        ...
                                        <textarea name="en_description" id="en_description" class="form-control" rows="4"></textarea>
