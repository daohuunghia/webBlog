                            ...
                            <div class="card card-primary">
                                ...
                                <div class="card-body row">
                                    <div class="form-group col-md-12 {{ $errors->first('vi_title') ? 'has-error' : '' }}">
                                        ...
                                        <input type="text" name="vi_title" value="{{ old('vi_title', $category->translate('vi')->title) }}" class="form-control" id="vi_title" />
                                    ...
                                    <div class="form-group col-md-12 {{ $errors->first('en_title') ? 'has-error' : '' }}">
                                        ...
                                        <input type="text" name="en_title" value="{{ old('en_title', $category->translate('en')->title) }}" class="form-control" id="en_title">
                                        ...
                                        <select name="parent_id" id="parent_id" class="form-control select2" style="width: 100%;">
                                            ...
                                            @if (!empty($categories))
                                                @foreach ($categories as $item)
                                                    <option {{ $category->parent_id == $item->id ? "selected" : '' }} value="{{ $item->id }}">{{ str_repeat('--', $item->level) }} {{$item->title}}</option>
                                                @endforeach
                                            @endif
                                        </select>
                                    </div>
                                    <div class="form-group col-md-12">
                                        ...
                                        <div class="row">
                                            <div class="col-md-8 mb-2">
                                                <input type="text" name="avatar" value="{{ old('avatar', $category->avatar) ?? '/backend/images/default.jpg' }}"
                                        ...
                                        <img id="image-preview-avatar" class="img-fluid"
                                             src="{{ old('avatar', $category->avatar) ?? '/backend/images/default.jpg' }}" style="max-width: 250px">
                                    </div>
                                    <div class="form-group col-md-12">
                                        <div class="row">
                                            <div class="col-md-3">
                                                <label for="status" class="d-block">{{ trans('backend.Status') }}</label>
                                                <input type="checkbox" name="status" class="form-control" {{ $category->status == \App\Models\Category::STATUS_ACTIVE ? 'checked' : '' }} data-bootstrap-switch data-off-color="danger" data-on-color="success">
                                            </div>
                                            <div class="col-md-3">
                                                <label for="hot" class="d-block">{{ trans('backend.Hot') }}</label>
                                                <input type="checkbox" name="hot" id="hot" class="form-control" {{ $category->hot == \App\Models\Category::HOT ? 'checked' : '' }} data-bootstrap-switch data-off-color="danger" data-on-color="success">
                                            </div>
                                        </div>
                                    </div>
                            ...
                            <div class="card card-primary">
                                ...
                                <div class="card-body row">
                                    <div class="form-group col-md-12 {{ $errors->first('vi_keyword') ? 'has-error' : '' }}">
                                        ...
                                        <textarea name="vi_keyword" id="vi_keyword" class="form-control" rows="4">{{ $category->translate('vi')->keyword }}</textarea>
                                    ...
                                    <div class="form-group col-md-12 {{ $errors->first('en_keyword') ? 'has-error' : '' }}">
                                        ...
                                        <textarea name="en_keyword" id="en_keyword" class="form-control" rows="4">{{ $category->translate('en')->keyword }}</textarea>
                                    ...
                                    <div class="form-group col-md-12 {{ $errors->first('vi_description') ? 'has-error' : '' }}">
                                        ...
                                        <textarea name="vi_description" id="vi_description" class="form-control" rows="4">{{ $category->translate('vi')->description }}</textarea>
                                    ...
                                    <div class="form-group col-md-12 {{ $errors->first('en_description') ? 'has-error' : '' }}">
                                        ...
                                        <textarea name="en_description" id="en_description" class="form-control" rows="4">{{ $category->translate('en')->description }}</textarea>
